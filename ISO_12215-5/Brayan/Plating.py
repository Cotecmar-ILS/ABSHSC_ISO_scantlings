...
class Plating():
    ...
    def wood_plating(self, b, sigma_uf, k2, pressure):
        print(self, b, sigma_uf, k2, pressure)
        sigma_d = 0.5 * sigma_uf
    ...
    def FRP_sandwich_plating(self, b, ar, c, sigma_ut, sigma_uc, Eio, tau_u, k2, k3, pressure):
        print(b, ar, c, sigma_ut, sigma_uc, Eio, tau_u, k2, k3, pressure)
        ...
        print("KC:", self.curvature_correction_kC(b, c))
        print("(",b**0.5,"*",self.curvature_correction_kC(b, c)**0.5,"*",pressure,"*",k2,") / (",6e5, "*",sigma_dt,")")
    ...
    def bottom_plating(self): # 1 Modificacion
        ...
        if self.craft.material == 'Fibra laminada':
            ...
            wos, wis, w_min = self.min_bottom_thickness(sigma_y=None,  sigma_uf=None)
