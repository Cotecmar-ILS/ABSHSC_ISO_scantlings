...
class Hull_Girder:
    ...
    def calculate_C(self) -> float:
        if self.craft.material == "Acero":
            ...
            raise ValueError(f"El material {self.craft.material}, no se encuentra en la base de datos")
